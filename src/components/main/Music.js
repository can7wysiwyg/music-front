...
const TrapMusic = () => {
  ...
  useEffect(() => {
    const showTrapMusic = async () => {
      const res = await axios.get("https://music-back.onrender.com/music/show_trap");
...
const TrapSong = ({ trapSong }) => {
  ...
  useEffect(() => {
    const getWork = async () => {
      const res = await axios.get("https://music-back.onrender.com/artwork/show_all");
...
const HipHopMusic = () => {
    ...
    useEffect(() => {
        ...
        const showHipHopMusic = async() => {
            const res = await axios.get('https://music-back.onrender.com/music/show_hip_hop')
...
const DanceHallMusic = () => {
    ...
    useEffect(() => {
        ...
        const showDancehallMusic = async() => {
            const res = await axios.get('https://music-back.onrender.com/music/show_dancehall')
